...
.url:hover
{
  ...
  <body>
	<div id="content">
		...
		<p class="expl">Generated by <a href="http://paladin.net" target="_blank" title="paladin NET">paladin NET</a>. This is styled version xml sitemap (for Google News), sorted by update date.</p>
