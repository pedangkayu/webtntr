  ...
  <form class="form" action="{{ url('/spa/' . $spa->id_spa) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
      <div class="col-sm-7">
        ...
        <div class="card">
          <textarea class="summernote" name="description" rows="8" cols="40">{!! old('description') ? old('description') : $spa->description !!}</textarea>
      	</div>
        ...
        <div class="card">
          <div class="card-head">
            <ul class="nav nav-tabs pull-right" data-toggle="tabs">
              <li class="active"><a href="#first1">BENEFIT</a></li>
      ...
      <div class="col-sm-5">
        ...
        <div class="card">
      		<div class="card-body">
						  ...
						  <div class="form-group">
  							...
  							<p class="help-block">https://twitter.com/paladin</p>
						  </div>
        ...
        <div class="card">
            ...
            <div class="form-group">
              ...
              <p class="help-block">Size: 300px x 300px</p>
            </div>
      		</div>
