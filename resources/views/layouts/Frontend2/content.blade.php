    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-3">
          <div class="logo"><a href="{{ url('/'.App::getLocale()) }}"><img src="{{ asset('/front/images/inner-logo-content.png') }}" alt="Logo" title="Company Profile"/></a></div>
        </div>
 ...
 <!-- /. Footer Start ./-->
  <section id="footer">
    ...
    <section class="footer-copy">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">&copy; 2018 &middot; <strong>{!! Format::paladin()->company !!}</strong> &middot; All Rights Reserved</div>
        </div>
      </div>
    </section>
...
<script>
  ...
  $('body').on('click', '.slug', function(){
    ...
    window.location.replace(origin+''+result+'/'+$(this).data('slug'));
  });

  $('body').on('click', '.slugdetail', function(){
    var result = window.location.href.split('/');
    var slug = 'http://'+result[2]+'/'+result[3]+'/'+result[4]+'/'+$(this).data('slug');
