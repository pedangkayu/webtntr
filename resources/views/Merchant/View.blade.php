			...
			<div class="card">
				<div class="card-body">
					<div class="form-group">
						...
						<h4 class="text-muted">Statistic Paid Booking &middot; {{ $item->item }}</h4>
			...
			<div class="card">
				<div class="card-body">
					<div class="form-group">
						...
						<h4 class="text-muted">Statistic Income  &middot; {{ $item->item }}</h4>
					</div>
			...
			<div class="card">
				...
				<div class="card-body no-padding">
					<ul class="list divider-full-bleed">
						<li class="tile">
							<a class="tile-content ink-reaction" href="{{ url('/item/' . $item->id_item . '/edit') }}">
								<div class="tile-icon">
						...
						<li class="tile">
							<a class="tile-content ink-reaction" href="{{ url($item->slug) }}" target="_blank">
								<div class="tile-icon">
						...
						<li class="tile">
							<a class="tile-content ink-reaction" href="{{ url('/item/servicepack?referal=' . base64_encode($item->id_item) . '&_k=' . csrf_token()) }}">
								<div class="tile-icon">
						...
						<li class="tile">
							<a class="tile-content ink-reaction" href="{{ url('/item/schedule?referal=' . base64_encode($item->id_item) . '&_k=' . csrf_token()) }}">
								<div class="tile-icon">
						...
						<li class="tile">
							<a class="tile-content ink-reaction" href="{{ url('/item/template/' . $item->id_item) }}">
								<div class="tile-icon">
